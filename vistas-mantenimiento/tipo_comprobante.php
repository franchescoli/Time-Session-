                    ...
                    <table style="" id="persona" class="table table-bordered table-condensed table-hover table-responsive">
                        ...
                        <tbody>
                            ...
                            foreach ($ListaTComprobante as $tcom) {
                                ...
                                <?php if($count == 0 & $estadoPersona == 0){?><tr><td colspan="12" style="font-family: oblique bold cursive; font-size: 18px" class="text-center">No Hay Topos de Comprobante Inactivos</td></tr>
                            <?php } if($count == 0 & $estadoPersona == 1){?><tr><td colspan="12" style="font-family: oblique bold cursive; font-size: 18px" class="text-center">No Hay Tipos de Comprobante Activos</td></tr><?php }?>
                        </tbody>
                    </table>
                </div>
            </div>
