...
$EditTipoMovimiento = isset($_POST['tipo_movimiento_id']) ? $_POST['tipo_movimiento_id'] : '';
?>
<div class="col-sm-12">
    <br>
    <section id="lista" class="col-sm-12 well well-sm backcolor" style="display: block; margin-bottom: -50px;">
        ...
        <article align="right" class="col-sm-6">
            ...
            <a class="btn btn-primary" onclick="AgregarTipoMovimiento()">Nuevo &nbsp;<i class="glyphicon glyphicon-plus"></i></a><!--  data-toggle="modal" data-target="#addPersona" -->
        </article>
    </section>
    <div id="listaTipMovimiento" class="col-md-12" style="padding: 0px; margin-top: 60px;">
                ...
                <div class="col-md-12" style="overflow: auto; padding: 0px;">
                    <table style="" id="persona" class="table table-bordered table-condensed table-hover table-responsive">
                        <thead class="bg-primary">
                            <tr>
                                <th>#</th>
                                <th hidden>Id Tipo Movimiento</th>
                        ...
                        <tbody>
                            <?php
                            $count = 0;
                            $ListaTipoMovimiento = Mantenimiento::ListaTipoMovimientoEstado($estadoPersona);

                            foreach ($ListaTipoMovimiento as $tmov) {
                                $count++;
                                ?>
                                <tr>
                                    <td><?php echo $count; ?></td>
                                    <td hidden><?php echo $tmov['tipo_movimiento_id']; ?></td>
                                    <td><?php echo $tmov['nombre_movimiento']; ?></td>
                                    <td><?php echo $tmov['estado']; ?></td>
                                    <td align="center">
                                        <a style="cursor: pointer;" onclick="Editar<?php echo $tmov['tipo_movimiento_id']; ?>(<?php echo $tmov['tipo_movimiento_id']; ?>)">
                            ...
                            <script>
                                function Editar<?php echo $tmov['tipo_movimiento_id']; ?>(tmovimiento) {
                                    $.ajax({
                                        stype: 'POST',
                                        url: "vistas-mantenimiento/tipo_movimiento.php",
                                        data: "EditPersona=" + tmovimiento,
                                        success: function (data) {
                                            $("#mantenimiento").html(data);
                                            ...
                                            document.getElementById('editarTipoMovimiento').style.display = 'block';
                                            document.getElementById("nombresEdit").focus();
                                        }
                                    });
                                }

                                function cancelarEditTipoMovimiento() {
                                    document.getElementById("edittmov").reset();
                                    document.getElementById('lista').style.display = 'block';
                                    document.getElementById('listaTipMovimiento').style.display = 'block';
                                    document.getElementById('editarTipoMovimiento').style.display = 'none';
                                    document.getElementById("buscador").focus();
                                }
                            </script>
                            </tr><?php } ?>
                            <?php if($count == 0 & $estadoPersona == 0){?><tr><td colspan="12" style="font-family: oblique bold cursive; font-size: 18px" class="text-center">No Hay Tipos de  Movimiento Inactivos</td></tr>
                            <?php } if($count == 0 & $estadoPersona == 1){?><tr><td colspan="12" style="font-family: oblique bold cursive; font-size: 18px" class="text-center">No Hay Tipos de Movimiento Activos</td></tr><?php }?>
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <div id="agregarTipoMovimiento" class="col-md-12" style="padding: 0px; display: none;">
        <div data-brackets-id="733" class="panel panel-primary">
            ...
            <div data-brackets-id="736" class="panel-body">
                <form id="addtmov" class="form-signin" role="form" method="post" action="mantenimiento">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group has-feedback">
                                <label for="nombres">Tipo de Movimiento</label>
                    ...
                    <h4 align="center">
                        <button type="button" class="btn btn-default" onclick="CancelarTipoMovimiento()"><!--  data-dismiss="modal" -->
    ...
    <div id="editarTipoMovimiento" class="col-md-12" style="padding: 0px; display: none;">
        <div data-brackets-id="733" class="panel panel-primary">
            <div data-brackets-id="734" class="panel-heading">
            ...
            <div data-brackets-id="736" class="panel-body">
                <form id="edittmov" class="form-signin" role="form" method="post" action="mantenimiento">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group has-feedback">
                                <label for="nombres">Tipo de Movimiento</label>
                    ...
                    <hr style="border-color: #3b5998;">
                    <h4 align="center">
                        <button type="button" class="btn btn-default" onclick="cancelarEditTipoMovimiento()"><!--  data-dismiss="modal" -->
                            Cancelar &nbsp;&nbsp; <i class="glyphicon glyphicon-remove-circle"></i>
                        </button>
                        <button class="btn btn-primary" type="submit">
