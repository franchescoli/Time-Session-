<?php
  ...
  $EditTipoDocumento = isset($_POST['tipo_documento_id']) ? $_POST['tipo_documento_id'] : '';
...
<div class="col-sm-12">
    ...
    <div id="listaTipoDocumento" class="col-md-12" style="padding: 0px; margin-top: 60px;">
                ...
                <div class="col-md-12" style="overflow: auto; padding: 0px;">
                    <table style="" id="persona" class="table table-bordered table-condensed table-hover table-responsive">
                        <thead class="bg-primary">
                            <tr>
                                <th>#</th>
                                <th hidden>Id Tipo de Documento</th>
                                <th>Documento</th>
                                <th>Estado</th>
                        ...
                        <tbody>
                            <?php
                            $count = 0;
                            $ListaTipoDocumento = Mantenimiento::ListaTipoDocumentoEstado($estadoPersona);

                            foreach ($ListaTipoDocumento as $tdoc) {
                                $count++;
                                ?>
                                <tr>
                                    <td><?php echo $count; ?></td>
                                    <td hidden><?php echo $tdoc['tipo_documento_id']; ?></td>
                                    <td><?php echo $tdoc['nombre']; ?></td>
                                    <td><?php echo $tdoc['estado']; ?></td>
                                    <td align="center">
                                        <a style="cursor: pointer;" onclick="Editar<?php echo $tdoc['tipo_documento_id']; ?>(<?php echo $tdoc['tipo_documento_id']; ?>)">
                                    ...
                                    <script>
                                function Editar<?php echo $tdoc['tipo_documento_id']; ?>(tcodumento) {
                                    $.ajax({
                                        stype: 'POST',
                                        url: "vistas-mantenimiento/tipo_documento.php",
                                        data: "EditTipoDocumento=" + tcodumento,
                                        success: function (data) {
                                            $("#mantenimiento").html(data);
                                ...
                                function cancelarEditTipoDocumento() {
                                    document.getElementById("edittdoc").reset();
                                ...
                                <?php if($count == 0 & $estadoPersona == 0){?><tr><td colspan="12" style="font-family: oblique bold cursive; font-size: 18px" class="text-center">No Hay Tipos de Documento Inactivos</td></tr>
                            <?php } if($count == 0 & $estadoPersona == 1){?><tr><td colspan="12" style="font-family: oblique bold cursive; font-size: 18px" class="text-center">No Hay Tipos de Documento Activos</td></tr><?php }?>
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <div id="agregarTipoDocumento" class="col-md-12" style="padding: 0px; display: none;">
        <div data-brackets-id="733" class="panel panel-primary">
            ...
            <div data-brackets-id="736" class="panel-body">
                <form id="addtdoc" class="form-signin" role="form" method="post" action="mantenimiento">
                    <div class="row">
                        <div class="col-sm-6">
    ...
    <div id="editarTipoDocumento" class="col-md-12" style="padding: 0px; display: none;">
        <div data-brackets-id="733" class="panel panel-primary">
            ...
            <div data-brackets-id="736" class="panel-body">
                <form id="edittdoc" class="form-signin" role="form" method="post" action="mantenimiento">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group has-feedback">
